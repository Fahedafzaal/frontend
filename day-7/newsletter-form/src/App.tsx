      ...
      <main className="flex flex-col items-center justify-center h-screen">
        <div className="card-image">
          <picture>
            ...
            <img src={signUpMobile} className="float-start" alt="Sign Up" />
          </picture>
        </div>
        <div className="card-content flex flex-col p-6 mt-4 gap-6">
          ...
          <div className="card-form">
            <form className="max-w-sm">
              ...
              <button
                type="submit"
                className="bg-blue-800 text-white rounded-lg block w-full p-4"
              >
